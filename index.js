...
app.post('/usuario', (req, res) => {
    ...
    const query = "INSERT INTO usuario (nomeusuario, emailusuario, idadeusuario) VALUES (?, ?, ?)";
...
app.get('/usuario', (req, res) => {
    ...
    connection.query("SELECT idusuario,nomeusuario, emailusuario, idadeusuario FROM usuario", (error, results) => {
        if (error) {
...
app.put('/usuario/:id', (req, res) => {
    ...
    const query = "UPDATE usuario SET nomeusuario = ?, emailusuario = ?, idadeusuario = ? WHERE idusuario = ?";
